...
namespace LuckyTex.Controls
{
    public class WatermarkBehavior : Behavior<TextBox>
    {
        ...
        /// <summary>
        /// The TextBox and PasswordBox Water Mark Adorner.
        /// </summary>
        public class WaterMarkAdorner : Adorner
        {
            ...
            public WaterMarkAdorner(UIElement element,
                string text, double fontsize, string font, Brush foreground)
                : base(element)
            {
            ...
            protected override void OnRender(System.Windows.Media.DrawingContext drawingContext)
            {
                ...
                if (this.AdornedElement is Control)
                {
                    Control ctrl = (this.AdornedElement as Control);
                    if (null != ctrl && 
                        ctrl.ActualWidth != double.NaN &&
                        ctrl.ActualHeight != double.NaN &&
                        text.Width != double.NaN && text.Height != double.NaN)
                    {
                        double halfWd = ctrl.ActualWidth / 2;
                        double halfHt = ctrl.ActualHeight / 2;
                        double halfLf = text.Width / 2;
                        double halfTp = text.Height / 2;
