...
```csharp
// From LABDataService.cs (lines 884-914)
public bool LAB_SAVELABGREIGERESULT(
    string P_BEAMERROLL,
    string P_LOOM,
    string P_ITMWEAVE,
    string P_TESTRESULT,
...
```csharp
// Save greige sample test result as PASS
bool success = labService.LAB_SAVELABGREIGERESULT(
    "BR-20231015-001",  // Beam roll
    "LOOM-05",          // Loom number
    "AB-1234-GRE",      // Greige item code
    "PASS",             // Test result
    1                   // First test
);

// Save failed result (requires retest)
bool success = labService.LAB_SAVELABGREIGERESULT(
    "BR-20231015-002",
    "LOOM-03",
    "AB-1234-GRE",
...
// Save retest result after fixing issues
bool success = labService.LAB_SAVELABGREIGERESULT(
    "BR-20231015-002",  // Same beam roll as failed test
    "LOOM-03",
    "AB-1234-GRE",
    "PASS",             // Now passed
