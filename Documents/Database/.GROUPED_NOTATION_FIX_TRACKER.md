...
- [ ] 009-WARP_GETSPECBYCHOPNOANDMC.md
  - Pattern: Likely TENSION_ST1-10
  - Need to check: Line TBD
...
**06_Finishing (10 files):**
- [ ] 091-FINISHING_GETCOATINGDATA.md
  - Pattern: Likely TEMP1-10_PV/SP, SATURATOR_CHEM_PV/SP, etc.
  - Need to check: Returns section

- [ ] 092-FINISHING_GETCOATINGREPORT.md
  - Pattern: Likely same as 091
  - Need to check: Returns section

- [ ] 093-FINISHING_INSERTCOATING.md
  - Pattern: Likely TEMP1-10 parameters, PV/SP pairs
  - Need to check: Input parameters

- [ ] 094-FINISHING_UPDATECOATING.md
  - Pattern: Likely same as 093
  - Need to check: Input parameters

- [ ] 095-FINISHING_UPDATECOATINGDATA.md
  - Pattern: Likely TEMP1-10_PV/SP parameters
  - Need to check: Input parameters

- [ ] 098-FINISHING_GETSCOURINGREPORT.md
  - Pattern: Likely TEMP_PV/SP, WASHING_PV/SP
  - Need to check: Returns section
